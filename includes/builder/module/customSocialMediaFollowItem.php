...
class custom_ET_Builder_Module_Social_Media_Follow_Item extends ET_Builder_Module {
	function init() {
		...
		$fields = array(
			'social_network'     => array(
				...
				'options'            => array(
					...
					'linktree'    => array(
						'value' => esc_html__( 'Linktree', 'et_builder' ),
					...
					'tik-tok'    => array(
						'value' => esc_html__( 'Tik-Tok', 'et_builder' ),
						'data'  => array( 'color' => '#3b5998' ),
					),
					'yelp'    => array(
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		if($social_network == 'tik-tok') {
			$this->add_classname( sprintf('deez-nutz'));
		}
