...
?>
	...
	<!--- Add conversion tracking code here --->
	<?php wp_head(); ?>
	<?php 
		$tracking = get_post_meta( get_the_ID(), 'tracking_code', true);
		if($tracking){
			echo $tracking;
		}
	?>
...
<?php
	...
	$top_header_add = get_option('top_header_add');
?>
	...
	<?php if ( $et_top_info_defined && ! $et_slide_header || is_customize_preview() ) : ?>
		...
		<div id="top-header"<?php echo $et_top_info_defined ? '' : 'style="display: none;"'; ?>>
			...
			<?php if ( $et_contact_info_defined ) : ?>
				...
				<div id="et-info">
				<?php if ($top_header_add) { ?>
					<span style="margin-right: 13px;"><?php echo $top_header_add ?></span>
				<?php } ?>
